...
interface IAccordionTrigger extends React.ComponentPropsWithoutRef<typeof AccordionPrimitive.Trigger> {
	trigger: React.ReactNode
}

const AccordionTrigger = React.forwardRef<React.ElementRef<typeof AccordionPrimitive.Trigger>, IAccordionTrigger>(
